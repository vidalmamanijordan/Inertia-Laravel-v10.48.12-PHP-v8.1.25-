  ...
  <AppLayout title="Contacts">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <h1 class="text-3xl font-semibold text-gray-700 mb-3">
        <span class="text-blue-500">Contactos</span> / Crear
      </h1>
      <div class="bg-white px-6 py-8 rounded-lg shadow">
        ...
        <div class="grid grid-cols-2 gap-6">
          <div class="relative">
            ...
            <span v-if="this.$page.props.errors && this.$page.props.errors.first_name" class="text-sm text-red-500">{{ this.$page.props.errors.first_name }}</span>
          </div>
          <div class="relative">
            ...
            <span v-if="this.$page.props.errors && this.$page.props.errors.last_name" class="text-sm text-red-500">{{ this.$page.props.errors.last_name }}</span>
          </div>
          <div class="relative">
            <select v-model="contact.organization_id" id="small"
              class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
              <option value="" selected disabled>Seleccione una Organización</option>
              <option v-for="organization in organizations" :key="'country-'+organization.id" :value="organization.id">
                {{ organization.name }}
              </option>
            </select>
            <span v-if="this.$page.props.errors && this.$page.props.errors.organization_id" class="text-sm text-red-500">{{ this.$page.props.errors.organization_id }}</span>
          </div>
          <div class="relative">
            ...
            <span v-if="this.$page.props.errors && this.$page.props.errors.email" class="text-sm text-red-500">{{ this.$page.props.errors.email }}</span>
          </div>
          <div class="relative">
            ...
            <span v-if="this.$page.props.errors && this.$page.props.errors.phone" class="text-sm text-red-500">{{ this.$page.props.errors.phone }}</span>
          </div>
          <div class="relative">
            ...
            <span v-if="this.$page.props.errors && this.$page.props.errors.address" class="text-sm text-red-500">{{ this.$page.props.errors.address }}</span>
          </div>
          <div class="relative">
            ...
            <span v-if="this.$page.props.errors && this.$page.props.errors.city" class="text-sm text-red-500">{{ this.$page.props.errors.city }}</span>
          </div>
          <div class="relative">
            ...
            <span v-if="this.$page.props.errors && this.$page.props.errors.state" class="text-sm text-red-500">{{ this.$page.props.errors.state }}</span>
          </div>
          <div class="relative">
            <select v-model="contact.country_id" id="small"
              class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <span v-if="this.$page.props.errors && this.$page.props.errors.country_id" class="text-sm text-red-500">{{ this.$page.props.errors.country_id }}</span>
          </div>
          <div class="relative">
            <input v-model="contact.postal_code" type="number"
              class="peer m-0 block h-[38px] w-full rounded border border-solid border-secondary-500 bg-transparent bg-clip-padding px-3 py-2 text-base font-normal leading-tight text-neutral-700 transition duration-200 ease-linear placeholder:text-transparent focus:border-primary focus:pb-[0.375rem] focus:pt-[1.125rem] focus:text-neutral-700 focus:outline-none peer-focus:text-primary dark:border-neutral-400 dark:text-white dark:autofill:shadow-autofill dark:focus:border-primary dark:peer-focus:text-primary [&:not(:placeholder-shown)]:pb-[0.375rem] [&:not(:placeholder-shown)]:pt-[1.125rem]"
            ...
            <span v-if="this.$page.props.errors && this.$page.props.errors.postal_code" class="text-sm text-red-500">{{ this.$page.props.errors.postal_code }}</span>
          </div>
        </div>
